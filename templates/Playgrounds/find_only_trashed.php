...
<div class="table-responsive">
	...
	<div class="btn-group shadow" role="group" aria-label="Basic example">
		<?= $this->Html->link(__('<i class="far fa-folder-open"></i>'), ['action' => 'view', $playground->id], ['class' => 'btn btn-outline-primary btn-xs', 'escapeTitle' => false]) ?>
		<?= $this->Html->link(__('<i class="fa-regular fa-pen-to-square"></i>'), ['action' => 'edit', $playground->id], ['class' => 'btn btn-outline-warning btn-xs', 'escapeTitle' => false]) ?>
